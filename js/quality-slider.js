(() => {
  ...
  const slides = [
    {
      src: "./assets/quality/01.jpg",
      alt: "Garden bench among tropical greenery",
      title: "Heritage Greens",
      location: "Dubai, United Arab Emirates",
    },
    {
      src: "./assets/quality/02.jpg",
      alt: "Rows of crops under open sky",
      title: "Flora Delight",
      location: "Nairobi, Kenya",
    },
    {
      src: "./assets/quality/03.jpg",
      alt: "Farmer in a field of yellow flowers",
      title: "Golden Acre",
      location: "Amsterdam, Netherlands",
    },
    {
      src: "./assets/quality/04.jpg",
      alt: "Agricultural fields at golden hour",
      title: "Root & Stem",
      location: "Goa, India",
    },
    {
      src: "./assets/quality/05.jpg",
      alt: "Greenhouse seedling work",
      title: "Open Field",
  ...
  if (reduceMotion) root.classList.add("quality--reduce-motion");
  ...
  function measure() {
    ...
    const cardW = Math.round(Math.min(h * 0.72, w * 0.32, 340));
    root.style.setProperty("--q-card-w", `${cardW}px`);
    const gapBetween = Math.round(Math.min(72, Math.max(40, w * 0.05)));
  ...
  function slotProps(i, pos) {
    ...
    return {
      x: t * spacing,
      y: absT * 10,
      rotation: reduceMotion ? 0 : t * SIDE_TILT,
  ...
  function startProgress() {
    ...
    if (reduceMotion) {
      progressTween = gsap.delayedCall(SLIDE_MS / 1000, () => step(1));
      return;
    }
  ...
  function buildCards() {
    track.innerHTML = slides
      ...
      <button
        ...
        tabindex="-1"
      >
        <img src="${slide.src}" alt="${slide.alt}" width="720" height="960" decoding="async" ${i === 0 ? 'fetchpriority="high"' : 'loading="lazy"'} />
      </button>`
      )
      .join("");
